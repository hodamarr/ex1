...
function Chat(props) {
    ...
    function onSend(type, message) {
        const newMessage = { content: message, time: currentTimeDate.getHours().toString() + ":" + currentTimeDate.getMinutes().toString(), self: true, type: type };
    ...
    return (
        <div className="container" style={{ display: "flex", padding: "0px", marginTop: "20px", height: "100%" }}>
                    ...
                    <nav className="navbar navbar-light bg-light" style={{width:"73vw", paddingRight:0}}>
                        <div className="container-fluid">
                            <div className="row g-3">
                                ...
                                <div className="col-auto">
                                    <button type="button" onClick={() => onSend('txt', msg)} className="btn btn-primary mb-3">Send</button>
                                </div>
                                <div className="col-auto">
                ...
                <div className="row g-3" style={{ backgroundColor: "#0d6efd", width: "180px", borderRadius: "20px", height: "40px" }}>
                    ...
                    <div className="col-auto" style={{ marginTop: "0px" }}>
                        <button className="btn btn-secondery sm" data-bs-toggle="modal" data-bs-target="#VideoPick" style={{
                            display: "block", marginLeft: "auto", marginRight: "auto"}} onClick={() => setShowMenu(false)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" className="bi bi-paperclip" viewBox="0 0 16 16">
            ...
            {/*attacments pop-ups*/ }
            <AddImage id="ImagePick" addNewPic={pic => onSend('image', pic)}/>
            <AddVideo id="VideoPick" addNewVid={video => onSend('video', video)}/>
            <AddRecord id="RecordPick" addNewRec={rec => onSend('audio', rec)}/>
        </div>
    );
}
